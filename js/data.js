      ...
      puzzle_bank: [
        {
          ...
          first_word: 8,
          description: 'Ένα άγριο ζώο της Αφρικής.',
        ...
        },
        {
          ...
          first_word: 7,
          description: 'Ένα κίτρινο φρούτο με μεγάλο κουκούτσι.',
          correct_answer: 'Μπανάνα',
        },
        {
          category: 'Έπιπλο',
          number_of_words: 1,
          total_number_of_letters: 7,
          first_word: 7,
          description: 'Κάτι πάνω στο οποίο κάθεσαι.',
          correct_answer: 'Καρέκλα',
        },
        {
          category: 'Επάγγελμα',
          number_of_words: 1,
          ...
          first_word: 9,
          description: 'Κάποιος που επισκευάζει αυτοκίνητα.',
          correct_answer: 'Μηχανικός',
        },
        {
          category: 'Πόλη',
          number_of_words: 1,
          ...
          first_word: 6,
          description: 'Η πρωτεύουσα της Γαλλίας.',
        ...
        },
        {
          ...
          total_number_of_letters: 6,
          first_word: 6,
          description: 'Κομμάτι τέχνης για να στολίζεις τον τοίχο σου.',
          correct_answer: 'Καμβάς',
        },
        {
          category: 'Εποχή',
          number_of_words: 1,
          ...
          first_word: 10,
          description: 'Ο πιο κρύος μήνας του χρόνου.',
          correct_answer: 'Ιανουάριος',
        },
        {
          category: 'Σπορ',
          number_of_words: 1,
          total_number_of_letters: 10,
          first_word: 10,
          description: 'Ένας αγώνας με τη χρήση μιας μπάλας.',
          correct_answer: 'Ποδόσφαιρο',
        },
        {
          category: 'Επίθετο',
          number_of_words: 1,
          total_number_of_letters: 5,
          first_word: 5,
          description: 'Το χρώμα του ουρανού.',
          correct_answer: 'Γαλάζιο',
        },
        {
          category: 'Τρόφιμο',
          number_of_words: 1,
          total_number_of_letters: 7,
          first_word: 7,
          description: 'Ένα λαχταριστό φαγητό με ζυμαρικά και κρέας.',
          correct_answer: 'Λαζάνια',
        },
        {  
          category: 'Ποτά',
          number_of_words: 1,
          total_number_of_letters: 5,
          first_word: 5, 
          description: 'Ένα γλυκό προϊόν.',
          correct_answer: 'Κακάο',
        },
        {  
          category: 'Γλυκό',
          number_of_words: 1,
        ...
        {  
          ...
          total_number_of_letters: 7,
          first_word: 7,
          description: 'Ένα είδος παπουτσιών.',
          correct_answer: 'Τακάκια',
        },
        {  
          category: 'Φαγητό',
          number_of_words: 1,
          total_number_of_letters: 8,
          first_word: 8, 
          description: 'Ένα παραδοσιακό φαγητό.',
          correct_answer: 'Τυρόπιτα',
        },
        {  
          category: 'Κτίριο',
          number_of_words: 1,
          total_number_of_letters: 9,
          first_word: 9,
          description: 'Ένας δημόσιος χώρος.',
          correct_answer: 'Τουαλέτες',
        },
        {  
          category: 'Κτίριο',
          number_of_words: 1,
          total_number_of_letters: 8,
          first_word: 8, 
          description: 'Ένας οργανισμός ή επιχείρηση.',
          correct_answer: 'Αρχηγείο',
        },
        {  
          category: 'Διασημότητα',
          number_of_words: 1,
          total_number_of_letters: 11,
          first_word: 11,
          description: 'Ένα επώνυμο πρόσωπο.',
          correct_answer: 'Τσολάκογλου',
        }
      ]
    },
    two_word_answers: {
